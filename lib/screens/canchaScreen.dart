            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: IconButton(onPressed: (){}, icon: const Icon(Icons.favorite_border_rounded, color: Colors.white, size: 35,)),
                  )
                ],
              ),
              Padding(
              ...
              const Center(
                child: Padding(
                    padding: EdgeInsets.only(top: 15.0, left: 20, bottom: 10),
                    child: Titulo(titulo: 'Comentario')
                ),
              ),
              Center(
                child: SizedBox(
              ...
              Center(
                child: Padding(
                  ...
                  child: MaterialButton(
                      height: 50,
                      minWidth: 350,
                      color: _dropDownValue == null ? AppConstants.green.withOpacity(0.3):AppConstants.green,
